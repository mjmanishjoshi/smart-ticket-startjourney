jQuery.sap.declare("demo.i042216.smart.devapp");
jQuery.sap.require("demo.i042216.smart.devlogon");

demo.i042216.smart.devapp = {
	smpInfo: {},
	//the variable hold demo.i042216.smart.devlogon instance
	devLogon: null,
		...
		if (window.sap_webide_FacadePreview) {
			...
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new demo.i042216.smart.devlogon();
